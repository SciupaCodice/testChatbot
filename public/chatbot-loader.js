...
(function() {
    ...
    const MODELS_API_URL = 'http://localhost:3000/models';
    ...
    // Carica impostazioni salvate o usa quelle predefinite
    ...
    async function fetchSettings() {
        try {
            // Recupera prima da localStorage
            const localSettings = loadSettingsFromLocalStorage();
            console.log('Impostazioni caricate da localStorage:', localSettings);
            if (localSettings) return localSettings;

            console.warn('Nessuna impostazione trovata in localStorage. Uso impostazioni predefinite.');
            return defaultSettings;
        } catch (error) {
